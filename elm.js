...
var $author$project$HomePage$receiveChunk = _Platform_incomingPort('receiveChunk', $elm$json$Json$Decode$string);
var $author$project$HomePage$receiveDone = _Platform_incomingPort('receiveDone', $elm$json$Json$Decode$string);
var $author$project$HomePage$receiveStop = _Platform_incomingPort('receiveStop', $elm$json$Json$Decode$string);
...
var $author$project$HomePage$sendMessage = _Platform_outgoingPort('sendMessage', $elm$json$Json$Encode$string);
...
var $author$project$HomePage$QuestionChanged = function (a) {
	return {$: 'QuestionChanged', a: a};
};
var $author$project$HomePage$Send = {$: 'Send'};
...
var $author$project$HomePage$submitQuestion = function (msg) {
	return A2(
...
var $author$project$HomePage$viewQuestion = F4(
	function (t, p, v, msg) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
...
var $author$project$HomePage$viewResponse = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$HomePage$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$HomePage$viewQuestion, 'text', 'What\'s up, Doc?', model.question, $author$project$HomePage$QuestionChanged),
				$author$project$HomePage$submitQuestion($author$project$HomePage$Send),
				$author$project$HomePage$viewResponse(model)
			]));
};
